...
DELAY_REQUESTS_FILE = os.getenv('DELAY_REQUESTS_FILE', os.path.join(BASE_DIR, 'data', 'project_delay_requests.json'))
PUBLIC_BASE_URL = os.getenv('PUBLIC_BASE_URL', 'https://ahyg.online-office.net')
FILE_PUBLIC_BASE_URL = os.getenv('FILE_PUBLIC_BASE_URL', 'https://www.mjmas.cn').strip().rstrip('/')
